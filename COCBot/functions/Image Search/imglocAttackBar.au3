...
Func AttackBarCheck($Remaining = False)
	...
	If $g_bDraggedAttackBar Then DragAttackBar($g_iTotalAttackSlot, True) ; return drag for the 2nd Recalc - Slot11 - Demen_S11_#9003
			...
			For $i = 0 To UBound($aResult) - 1
				...
				If $aResult[$i][1] > 0 Then
					...
					Else
						...
						$aResult[$i][4] = -1
					EndIf
					If $aResult[$i][4] <= 10 Then ; Slot11 - Demen_S11_#9003
	...
	; Drag & checking Slot11 - Demen_S11_#9003
